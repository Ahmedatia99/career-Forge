		...
		<footer className='border-t border-border bg-muted/30 py-12 px-4'>
			<div className='max-w-6xl mx-auto'>
				<div className='grid md:grid-cols-4 grid-cols-2 gap-8 mb-8'>
					...
					<div className='space-y-4'>
						...
						<div className='flex gap-3'>
							<Link href='#'>
								<Image src='icons8-x.svg' alt='Twitter' width={20} height={20} />
							</Link>
							<Link href='#'>
								<Image src='icons8-linkedin.svg' alt='Twitter' width={20} height={20} />
							</Link>
						</div>
					</div>
				...
				<div className='border-t border-border pt-8'>
					<p className='text-sm text-muted-foreground text-center'>© 2026 CareerForge ATS. All rights reserved.</p>
				</div>
			</div>
		</footer>
	);
