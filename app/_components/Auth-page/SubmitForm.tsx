  ...
  return (
    <>
      ...
      <Button
        variant="outline"
        disabled={loading}
        className="w-full h-11 sm:h-12 border-2 border-slate-300 rounded-full font-semibold text-sm sm:text-base text-slate-900 hover:bg-white hover:text-slate-900 hover:border-slate-900 bg-white transition-all disabled:opacity-50 disabled:cursor-not-allowed"
      >
