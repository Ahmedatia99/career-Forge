...
export function SubmitForm({ handleSubmit, isLogin }: { handleSubmit: () => void; isLogin: boolean }) {
	return (
		<>
			<Button
				...
				{isLogin ? 'Login' : 'Register'} <ArrowRight className='w-4 sm:w-5 h-4 sm:h-5' />
			</Button>
			...
			<Button
				variant='outline'
				className='w-full h-11 sm:h-12 border-2 border-slate-300 rounded-full font-semibold text-sm sm:text-base text-slate-900 hover:bg-white hover:text-slate-900 hover:border-slate-900 bg-white transition-all'>
