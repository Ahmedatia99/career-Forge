import { BrandingSectionProps } from "@/types";
...
export function BrandingSection({ isMobile = false }: BrandingSectionProps) {
    ...
    return (
      <div className="lg:hidden text-center px-4 mb-6 sm:mb-8">
        ...
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed max-w-sm mx-auto">
          Build professional resumes in minutes with our advanced AI technology
  ...
  return (
    <div className="hidden lg:block text-left px-4 relative">
      <div className="absolute -top-7 -left-5 w-100 h-95 border-t-2 rounded-tr-none rounded-bl-none border-t-gray-500/5 border-l-2 border-l-gray-500/5 rounded-4xl" />
