        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <Accordion type="multiple" defaultValue={["personal", "summary"]} className="space-y-4">
              <AccordionItem value="personal" className="rounded-lg border bg-card px-6">
              ...
              <AccordionItem value="summary" className="rounded-lg border bg-card px-6">
                <AccordionTrigger className="hover:no-underline">
                ...
                <AccordionContent className="pb-6 pt-4">
                  <ProfessionalSummarySection
                    ...
                    onChange={(data) => setCvData({ ...cvData, professionalSummary: data })}
                  />
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="experience" className="rounded-lg border bg-card px-6">
                <AccordionTrigger className="hover:no-underline">
              ...
              <AccordionItem value="skills" className="rounded-lg border bg-card px-6">
                <AccordionTrigger className="hover:no-underline">
                  <span className="text-lg font-semibold">Skills</span>
                </AccordionTrigger>
                <AccordionContent className="pb-6 pt-4">
                  <SkillsSection data={cvData.skills} onChange={(data) => setCvData({ ...cvData, skills: data })} />
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="projects" className="rounded-lg border bg-card px-6">
                <AccordionTrigger className="hover:no-underline">
              ...
              <AccordionItem value="languages" className="rounded-lg border bg-card px-6">
                <AccordionTrigger className="hover:no-underline">
          ...
          <div className="lg:sticky lg:top-8 lg:h-fit">
            <CVPreview data={cvData} onTemplateChange={(template) => setCvData({ ...cvData, template })} />
          </div>
        </div>
      </div>
    </div>
