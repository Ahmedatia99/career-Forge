...
const Logo = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <Image src="/logo.png" alt="Logo" width={40} height={40} {...props} />
  );
};
...
export const Navbar01 = React.forwardRef<HTMLElement, Navbar01Props>(
  (
    ...
    return (
      <header
        ref={combinedRef}
        className={`sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-supports-backdrop-filter:bg-background/60 px-4 md:px-6 ${className}`}
        {...props}
      >
